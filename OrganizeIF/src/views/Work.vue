...
<script>
import { computed, defineComponent, onMounted, reactive, ref, alertController } from "vue";
...
export default defineComponent({
    ...
    setup(){
        ...
        return {
            ...
            ellipsisVertical, briefcase, trash, add, doneTask, notDoneTask, deleteTask, mudarcor
        }
    }
